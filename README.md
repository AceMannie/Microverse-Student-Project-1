...
<div align="center">
 ...
 <h3><b>Microverse-Student-Project 1 Mobile- first</b></h3>
...
A Developer can use linter tool to check for errors, it provides suggestions for how to improve your code. By using a linter, you can identify and fix issues before they become larger problems.
...
```sh
  cd my-folder
  git clone https://github.com/AceMannie/Microverse-Student-Project-1.git
```
...
I would like to thank Microverse for providing the essential tools for this project .
